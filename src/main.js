...
// Format result: remove trailing .00 if exact integer
...
function convert(value) {
  conversions.forEach((conversion) => {
    ...
    const metricToImperial = formatResult(value * conversion.factor);
    const imperialToMetric = formatResult(value / conversion.factor);
